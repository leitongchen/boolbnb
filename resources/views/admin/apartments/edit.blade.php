...
<div class="form-group">
        ...
        <input class="form-control" type="checkbox" name="visible" id="visible" value="{{ $apartment->visible }}"> <br>
       </div>
        {{-- @foreach($extraServices as $extraService)
        <label>
            <input class="form-control" name="exreaServices[]" type="checkbox" value="{{ $extraService->id }}" {{ $apartment->extraServices->contains($extraService) ? 'checked' : '' }}>
